...
const rawArtEntities = [
  ...
  },
  {
    ...
    title: 'Vasiliy Kandinskiy',
    startDate: '1866-12-16',
    endDate: '1944-12-13',
    type: 'Lifetime',
    children: [],
    tags: ['art'],
...
export const artEntities: TimelineEntity[] = importEntitiesWithDayjs(rawArtEntities)
