...
const rawInformationTechnologyEntities = [
  {
    id: 'claude-shannon',
    title: 'Claude Shannon',
    startDate: '1916-04-30',
    endDate: '2001-02-24',
    type: 'Lifetime',
    children: [],
  ...
  },
  {
    ...
    children: [
      {
        id: 'first-bombe-installed',
        title: 'First bombe installed',
        startDate: '1940-03-18',
        type: 'Milestone',
        children: [],
        tags: [],
        importance: 4,
...
export const informationTechnologyEntities: TimelineEntity[] = importEntitiesWithDayjs(rawInformationTechnologyEntities)
