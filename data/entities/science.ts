...
export const scienceEntities: TimelineEntity[] = [
  ...
  {
    id: 'hanaoka-seishu',
    title: 'Hanaoka Seishū',
    startDate: '1760-10-23',
    endDate: '1835-11-21',
    type: 'Lifetime',
    children: [],
  ...
  },
  {
    ...
    children: [
      {
        id: 'movable-type-printing-europe',
        title: 'First movable type printing in Europe',
        startDate: '1450',
        type: 'Milestone',
        children: [],
        tags: [],
  ...
  },
  {
    ...
    children: [
      {
        id: 'movable-type-printing-china',
        title: 'First movable type printing in China',
        startDate: '1040',
        type: 'Milestone',
        children: [],
        tags: [],
  ...
  {
    id: 'anaesthesia',
    title: 'First Public Demonstration of Anaesthesia',
